enum CALLBACK_DATA {
  ...
  SUBJECT_LINK_TO_NOTIFICATION = 'SUBJECT_LINK_TO_NOTIFICATION',
  ...
  NOTIFICATION_REMOVE_SUBJECT = 'NOTIFICATION_REMOVE_SUBJECT',
  NOTIFICATION_DISCARD_SUBJECT = 'NOTIFICATION_DISCARD_SUBJECT',
